...
function App() {
  ...
  useEffect(() => {
    axios.get(`${API_URL}/promotions`).then((res) => setPromotions(res.data)).catch(() => setError('Ошибка загрузки акций'));
    axios.get(`${API_URL}/promotional-products`).then((res) => setPromotionalProducts(res.data)).catch(() => setError('Ошибка загрузки акционных товаров'));
    axios.get(`${API_URL}/new-products`).then((res) => setNewProducts(res.data)).catch(() => setError('Ошибка загрузки новинок'));
    axios.get(`${API_URL}/hits-products`).then((res) => setHitsProducts(res.data)).catch(() => setError('Ошибка загрузки хитов'));
  }, []);

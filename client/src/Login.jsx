...
function Login({ isRegistrationActive, setRegistrationActive, isPhoneConfirmActive, setPhoneConfirmActive }) {
    ...
    <div className='login-main-container'>
      ...
      {!isPhoneConfirmActive && (
        <div className='login-form'>
          ...
          {isRegistrationActive && (
            <input type='password' name='confirmPassword' value={form.confirmPassword} onChange={handleChange} placeholder='Подтвердите пароль' />
          )}
          <button onClick={handlePhoneConfirm}>{isRegistrationActive ? 'Зарегистрироваться' : 'Войти'}</button>
          <p onClick={handleRegistration}>
            {isRegistrationActive ? 'Уже зарегистрированы? Нажмите сюда' : 'Еще не зарегистрированы? Нажмите сюда'}
          </p>
        </div>
      )}
      {isPhoneConfirmActive && (
        <div className='login-form'>
          <h1>Введите код</h1>
          <p className='login-form-description'>Мы отправили на указанный номер телефона СМС с кодом подтверждения, введите его сюда</p>
          <input name='code' value={form.code} onChange={handleChange} placeholder='Код' />

...
function Cart({
  ...
  const validateForm = () => {
      ...
      if (!formData.postal_code) {
        newErrors.postal_code =
          language === "rus"
            ...
            : "Пошта индексін енгізіңіз";
      } else if (
        !postalCodeRegex.test(formData.postal_code.replace(/\D/g, ""))
      ) {
        newErrors.postal_code =
          language === "rus"
    ...
    if (!cart || cart.length === 0) {
      newErrors.cart = language === "rus" ? "Корзина пуста" : "Себет бос";
    }
  ...
  return (
    <div className="cart-container" ref={cartContainerRef}>
                ...
                <img
                  src={
                    item.product.image_url
                      ? `${API_URL}/${item.product.image_url.replace(
                          "/images/",
                          ""
                        )}`
      ...
      <div
        ...
        style={{
          height: isPaymentActive ? "100%" : "auto",
      ...
      >
        ...
        >
          <p>
            {language === "rus" ? "Общая сумма" : "Жалпы сома"}:{" "}
            {calculateTotal().toLocaleString("ru-RU")} тг.
          </p>
        </div>
        ...
        >
          ...
          >
            ...
            <div className="order-type-text">
              <p
                style={{ color: isDeliveryTypeActive ? "#fff" : "#263242" }}
                className="order-type-title"
              >
                {language === "rus"
                  ? "ДОСТАВКА ПОЧТОЙ"
                  : "ПОШТА АРҚЫЛЫ ЖЕТКІЗУ"}
              </p>
              <p
                className="order-type-subtitle"
                style={{ color: isDeliveryTypeActive ? "#fff" : "#263242" }}
              >
                KazPost, СДЭК, РИКА
              </p>
          ...
          >
            ...
            <div className="order-type-text">
              <p
                style={{ color: isPickupTypeActive ? "#fff" : "#263242" }}
                className="order-type-title"
              >
          ...
          <div>
            ...
            <div className="input-container">
              <IMaskInput
                ...
                name="postal_code"
                placeholder={
                  language === "rus" ? "Почтовый индекс" : "Пошта индексі"
                }
        ...
        >
          <button onClick={handlePaymentSubmit}>
            {language === "rus" ? "Оплатить" : "Төлеу"} (
            {calculateTotal().toLocaleString("ru-RU")} тенге)
          </button>
        </div>

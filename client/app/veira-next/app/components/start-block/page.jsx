...
function StartBlock() {
  ...
  return (
    <div className={styles["start-block"]}>
      <div className={styles["start-block-images"]}>
        <img
          src="/images/start-block-image-1.png"
          className={styles["start-block-image-1"]}
          alt="product visual 1"
        />
        <img
          src="/images/start-block-image-2.png"
          className={styles["start-block-image-2"]}
          alt="product visual 2"
        />
      </div>

      <div className={styles["start-block-information"]}>
      ...
      <img src="/images/logo.png" alt="veira-logo" className={styles.logo} />
